...
<?php while ($row=mysqli_fetch_array($result)) {?>
	...
	<td>
		<BUTTON><a href="halaman_admin.php?a=edit&id=<?php echo $row['idmhs'];?>">EDIT</a></BUTTON>
		<BUTTON><a href="halaman_admin.php?a=delete&id=<?php echo $row['idmhs'];?>">HAPUS</a></BUTTON>
	</td>
	</tr>
...
<button><a href="halaman_admin.php?a=list">Batal</a></button>
</form>
