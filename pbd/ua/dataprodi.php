...
function read_data()
{
	...
	<h2>Daftar Data Program Studi</h2>
	<table border="1" cellpadding="2" class="table1">
	
	<button><a href="dataprodi.php?a=input">INPUT</a></button>
	<br><br>
		<tr class="re">
			<td>ID</td>
			<td>KODE</td>
...
<?php while ($row=mysqli_fetch_array($result)) {?>
	...
	<td>
		<button><a href="dataprodi.php?a=edit&id=<?php echo $row['idprodi'];?>">EDIT</a></button>
		<button><a href="dataprodi.php?a=delete&id=<?php echo $row['idprodi'];?>">HAPUS</a></button>
	</td>
	</tr>
...
<button><a href="dataprodi.php?a=list">Batal</a></button>
</form>
...
<a href="dataprodi.php?a=list">Batal</a>
